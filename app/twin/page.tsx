    ...
    <div className="relative min-h-screen bg-black text-slate-100 overflow-hidden font-sans selection:bg-sky-500/30">
      ...
      <main className="relative z-10 flex flex-col min-h-screen p-6 md:p-12 pointer-events-none">
        ...
        <header className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-light tracking-tighter">Digital Twin</h1>
            ...
            {/* Os números vêm de l4s.simulateBioState(). Sem este rótulo a
                página se apresenta como telemetria real de alguém. */}
            <p className="mt-3 inline-block rounded-full border border-amber-400/40 bg-amber-400/10 px-3 py-1 text-[11px] font-medium uppercase tracking-widest text-amber-200">
              Simulated data · interface preview
            </p>
          </div>
